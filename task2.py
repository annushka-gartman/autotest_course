def repeats(our_str):
    """
    The function counts how many each character has already been encountered
    :param our_str: String with letters
    :return new_str: A string in the form 'letter_quantity'
    """
    letters_dict = {}
    new_str = ''
    for letter in our_str:
        if letter in letters_dict:
            ...
            letters_dict[letter] = 1
        new_str = '{}{}_{}'.format(new_str, letter, letters_dict.get(letter))
    return new_str
