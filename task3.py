def everything_for_your_cat(cats_data):
    """
    The function displays for each owner all his pets and the age of the pet
    :param cats_data: Book about cats and their owners
    :return our_str: Strings in the format owner: cat name, cat age
    """
    dictionary = {}
    for entry in cats_data:
        fio = f'{entry[2]} {entry[3]}'  # Write first and last name in a string
        if fio not in dictionary:
            dictionary[fio] = f'{entry[0]}, {entry[1]}'
        else:
            dictionary[fio] = dictionary[fio] + f'; {entry[0]}, {entry[1]}'
    our_str = ''
